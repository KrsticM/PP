...
{
       0,    56,    56,    68,    69,    74,    86,    73,   102,   108,
     110,   120,   119,   127,   129,   132,   144,   146,   150,   159,
     161,   165,   166,   167,   168,   169,   172,   184,   188,   201,
     203,   224,   226,   232,   238,   243,   246,   252,   251,   271,
     273,   285,   288,   294,   299,   293,   313,   323
};
#endif
...
static const char *const yytname[] =
{
  ...
  "$@2", "type", "parameter", "body", "$@3", "global_var_list",
  "global_var", "variable_list", "variable", "statement_list", "statement",
  "inc_statement", "compound_statement", "assignment_statement", "num_exp",
  "exp", "literal", "function_call", "$@4", "argument", "if_statement",
...
{
     -54,     2,    39,   -54,   -54,    39,   -54,     8,   -54,   -54,
      11,    28,   -54,   -54,    20,    39,    37,    34,   -54,   -54,
      35,   -54,   -54,    39,    41,   -54,   -54,    31,     4,   -54,
      40,    27,    15,   -54,   -54,   -54,   -54,   -54,   -54,   -54,
      44,   -54,   -54,    42,   -54,   -54,    27,    12,   -54,   -54,
     -54,    27,    36,    19,     0,    27,    43,     3,   -54,    27,
      23,   -54,   -54,   -54,    24,   -54,    27,   -54,   -54,   -54,
      27,    45,    38,    46,    38,     0,   -54,   -54
};
...
{
      13,     0,     0,     1,     8,     2,     3,     0,    14,     4,
       0,     5,     5,    15,     0,     9,     0,     0,    10,     6,
       0,    16,     7,    11,     0,    19,    17,     0,     0,    18,
       0,     0,     0,    19,    12,    20,    25,    21,    22,    23,
      41,    24,    43,    32,    35,    36,     0,     0,    29,    31,
      33,     0,     0,     0,     0,     0,     0,     0,    47,     0,
       0,    26,    27,    42,     0,    44,    39,    34,    30,    28,
       0,     0,    40,     0,    46,     0,    38,    45
};
...
{
     -54,   -54,   -54,    50,   -54,   -54,    -2,   -54,   -54,   -54,
     -54,   -54,   -54,   -54,    25,   -53,   -54,   -54,   -54,   -46,
...
{
      -1,     1,     5,     6,    14,    20,     7,    17,    22,    25,
       2,     8,    23,    26,    28,    35,    36,    37,    38,    47,
      48,    49,    50,    56,    73,    39,    40,    55,    71,    65,
      41
};
...
{
      57,    63,     3,    10,    30,    60,    31,    32,    30,    64,
      31,    32,    33,    16,    67,    11,    33,    34,    12,    59,
      72,    24,    77,    30,    74,    31,    32,    58,    59,    51,
      15,    33,    62,    52,    43,    44,    45,    46,    69,    59,
      59,    70,     4,    13,    18,    19,    29,    21,    27,    54,
      42,    61,   -37,    66,    59,     9,    75,    76,    53,     0,
      68
};

static const yytype_int8 yycheck[] =
{
      46,    54,     0,     5,     4,    51,     6,     7,     4,    55,
       6,     7,    12,    15,    11,     7,    12,    13,     7,    16,
      66,    23,    75,     4,    70,     6,     7,    15,    16,    14,
      10,    12,    13,    18,     7,     8,     9,    10,    15,    16,
      16,    17,     3,    15,     7,    11,    15,    12,     7,     5,
      10,    15,    10,    10,    16,     5,    11,    11,    33,    -1,
      59
};
...
{
       0,    21,    30,     0,     3,    22,    23,    26,    31,    23,
      26,     7,     7,    15,    24,    10,    26,    27,     7,    11,
      25,    12,    28,    32,    26,    29,    33,     7,    34,    15,
       4,     6,     7,    12,    13,    35,    36,    37,    38,    45,
      46,    50,    10,     7,     8,     9,    10,    39,    40,    41,
      42,    14,    18,    34,     5,    47,    43,    39,    15,    16,
      39,    15,    13,    35,    39,    49,    10,    11,    40,    15,
      17,    48,    39,    44,    39,    11,    11,    35
};
...
static const yytype_uint8 yyr1[] =
{
      ...
      27,    29,    28,    30,    30,    31,    32,    32,    33,    34,
      34,    35,    35,    35,    35,    35,    36,    37,    38,    39,
      39,    40,    40,    40,    40,    41,    41,    43,    42,    44,
      44,    45,    45,    47,    48,    46,    49,    50
};
...
#line 1305 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 1330 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 133 "micko.y" /* yacc.c:1646  */
    {
  	if(lookup_symbol((yyvsp[-1].s), GLVAR) == -1)
	{
    	insert_symbol((yyvsp[-1].s), GLVAR, (yyvsp[-2].i), NO_ATR, NO_ATR);
		code("\n\t\t\t%s:	WORD	1", (yyvsp[-1].s));	
	}	
    else 
    	err("redefinition of '%s'", (yyvsp[-1].s));
  }
#line 1389 "micko.tab.c" /* yacc.c:1646  */
    break;

  case 18:
#line 151 "micko.y" /* yacc.c:1646  */
    {
        if(lookup_symbol((yyvsp[-1].s), VAR|PAR|GLVAR) == -1)
...
#line 173 "micko.y" /* yacc.c:1646  */
    {
		int idx = lookup_symbol((yyvsp[-2].s), (VAR|PAR|GLVAR));
        if(idx == -1)
          err("'%s' undeclared", (yyvsp[-2].s));
		code("\n\t\t\tADDS\t");
		print_symbol(idx); code(", $1, "); print_symbol(idx);
   	  }
...
#line 189 "micko.y" /* yacc.c:1646  */
    {
        int idx = lookup_symbol((yyvsp[-3].s), (VAR|PAR|GLVAR));
        if(idx == -1)
...
#line 227 "micko.y" /* yacc.c:1646  */
    {
        (yyval.i) = lookup_symbol((yyvsp[0].s), (VAR|PAR|GLVAR));
        if((yyval.i) == -1)
