  ...
  _TO literal
	{
		int idx = lookup_symbol($4, (VAR|PAR));
		gen_cmp(idx, $10);
		code("\n\t\t\tJGES\t@for_false%d",$<i>3);
    gen_snlab("for_true", $<i>3);
	}
	steping // sad samo dodavam ovo sto mi ovo vrati na ID ovaj, nema nikakvih nizova
  _RPAREN statement 
	{
		int idx = lookup_symbol($4, (VAR|PAR));
