...
#line 175 "micko.tab.c" /* yacc.c:358  */
...
{
       0,    62,    62,    74,    75,    80,    92,    79,   108,   114,
     116,   126,   125,   134,   136,   140,   149,   151,   155,   156,
     157,   158,   159,   164,   169,   174,   163,   221,   224,   231,
     235,   248,   250,   271,   273,   280,   286,   291,   294,   300,
     299,   319,   321,   333,   336,   342,   347,   341,   361,   371
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_DIRECTION", "_FOR", "_STEP", "$accept", "program", "function_list",
  "function", "$@1", "$@2", "type", "parameter", "body", "$@3",
  "variable_list", "variable", "statement_list", "statement",
  "for_statement", "@4", "$@5", "$@6", "steping", "compound_statement",
...
{
       0,   -64,     5,     0,   -64,     2,   -64,   -64,   -64,    12,
       0,    22,    14,   -64,   -64,    23,   -64,   -64,     0,    32,
     -64,   -64,    30,     7,   -64,    45,    40,    39,   -64,   -64,
       0,   -64,   -64,   -64,   -64,   -64,    51,   -64,   -64,    47,
     -64,   -64,    40,     1,   -64,   -64,   -64,    40,    24,    52,
      34,    40,    48,    -9,   -64,    40,    18,   -64,   -64,   -64,
      26,   -64,    40,   -64,   -64,   -64,    46,    40,    50,    49,
      53,    43,    49,    34,   -64,   -64,   -64,    44,    43,   -64,
      41,    43,    34,   -64,   -64
};
...
{
       0,     8,     0,     2,     3,     0,     1,     4,     5,     0,
       9,     0,     0,    10,     6,     0,    13,     7,    11,     0,
      16,    14,     0,     0,    15,     0,     0,     0,    16,    12,
       0,    17,    22,    18,    19,    20,    43,    21,    45,    34,
      37,    38,     0,     0,    31,    33,    35,     0,     0,     0,
       0,     0,     0,     0,    49,     0,     0,    29,    23,    44,
       0,    46,    41,    36,    32,    30,     0,     0,     0,    42,
       0,     0,    48,     0,    40,    24,    47,     0,     0,    25,
      27,     0,     0,    28,    26
};
...
{
     -64,   -64,   -64,    63,   -64,   -64,    -6,   -64,   -64,   -64,
     -64,   -64,    42,   -50,   -64,   -64,   -64,   -64,   -64,   -64,
     -64,   -41,    13,   -63,   -64,   -64,   -64,   -64,   -64,   -64,
     -64,   -64,   -64
};
...
{
      -1,     2,     3,     4,     9,    15,     5,    12,    17,    20,
      18,    21,    23,    31,    32,    66,    77,    80,    82,    33,
      34,    43,    44,    45,    46,    52,    70,    35,    36,    51,
      68,    61,    37
};
...
{
      59,    53,    63,     1,    11,     6,    56,    55,    75,     8,
      60,    25,    19,    26,    27,    79,    54,    55,    83,    28,
      29,    69,    10,    76,    49,    14,    72,    30,    25,    13,
      26,    27,    84,    65,    55,    16,    28,    57,    25,    22,
      26,    27,    55,    67,    30,    24,    28,    39,    40,    41,
      42,    40,    41,    47,    30,    38,    50,   -39,    62,    58,
      71,    73,    81,    78,    74,    55,     7,     0,    64,     0,
      48
};

static const yytype_int8 yycheck[] =
{
      50,    42,    11,     3,    10,     0,    47,    16,    71,     7,
      51,     4,    18,     6,     7,    78,    15,    16,    81,    12,
      13,    62,    10,    73,    30,    11,    67,    20,     4,     7,
       6,     7,    82,    15,    16,    12,    12,    13,     4,     7,
       6,     7,    16,    17,    20,    15,    12,     7,     8,     9,
      10,     8,     9,    14,    20,    10,     5,    10,    10,     7,
      14,    11,    21,    19,    11,    16,     3,    -1,    55,    -1,
      28
};
...
{
       0,     3,    23,    24,    25,    28,     0,    25,     7,    26,
      10,    28,    29,     7,    11,    27,    12,    30,    32,    28,
      31,    33,     7,    34,    15,     4,     6,     7,    12,    13,
      20,    35,    36,    41,    42,    49,    50,    54,    10,     7,
       8,     9,    10,    43,    44,    45,    46,    14,    34,    28,
       5,    51,    47,    43,    15,    16,    43,    13,     7,    35,
      43,    53,    10,    11,    44,    15,    37,    17,    52,    43,
      48,    14,    43,    11,    11,    45,    35,    38,    19,    45,
      39,    21,    40,    45,    35
};
...
{
       0,    22,    23,    24,    24,    26,    27,    25,    28,    29,
      29,    31,    30,    32,    32,    33,    34,    34,    35,    35,
      35,    35,    35,    37,    38,    39,    36,    40,    40,    41,
...
#line 1331 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 1353 "micko.tab.c" /* yacc.c:1646  */
    break;

  case 8:
#line 109 "micko.y" /* yacc.c:1646  */
    {  (yyval.i) = (yyvsp[0].i); }
#line 1359 "micko.tab.c" /* yacc.c:1646  */
    break;
...
#line 164 "micko.y" /* yacc.c:1646  */
    {
			int idx = insert_symbol((yyvsp[0].s), VAR, (yyvsp[-1].i), ++var_num, ++for_num);
			(yyval.i) = idx;
	}
...
#line 169 "micko.y" /* yacc.c:1646  */
    {
			gen_mov((yyvsp[0].i), (yyvsp[-2].i));
			code("\n@for%d:", get_atr2((yyvsp[-2].i)));
	}
#line 1414 "micko.tab.c" /* yacc.c:1646  */
    break;

  case 25:
#line 174 "micko.y" /* yacc.c:1646  */
    {
			gen_cmp((yyvsp[-5].i), (yyvsp[0].i));
			if(get_type((yyvsp[-5].i)) == INT)
			{
				if((yyvsp[-1].i) == 0)
						code("\nJGES\t@for_exit%d", get_atr2((yyvsp[-5].i)));
				else
						code("\nJLES\t@for_exit%d", get_atr2((yyvsp[-5].i)));
			}
			else
			{
				if((yyvsp[-1].i) == 0)
						code("\nJGEU\t@for_exit%d", get_atr2((yyvsp[-5].i)));
				else
						code("\nJLEU\t@for_exit%d", get_atr2((yyvsp[-5].i)));
			}
	}
#line 1436 "micko.tab.c" /* yacc.c:1646  */
    break;

  case 26:
#line 192 "micko.y" /* yacc.c:1646  */
    {
			if((yyvsp[-4].i) == 0)
			{
					code("\n\t\t\t%s\t", get_arop_stmt(ADD, get_type((yyvsp[-8].i))));
			}
			else
			{
					code("\n\t\t\t%s\t", get_arop_stmt(SUB, get_type((yyvsp[-8].i))));
			}
			print_symbol((yyvsp[-8].i));
			code(",");
			if((yyvsp[-1].i) == -1)
			{
					code("$1,");
			...
			{
					print_symbol((yyvsp[-1].i));
					code(",");				
			}
			print_symbol((yyvsp[-8].i));
			code("\n\t\t\tJMP \t@for%d", get_atr2((yyvsp[-8].i)));
			code("\n@for_exit%d:", get_atr2((yyvsp[-8].i)));
