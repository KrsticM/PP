...
static const yytype_uint8 yyrline[] =
{
     ...
     179,   182,   188,   187,   205,   207,   217,   228,   229,   233,
     237,   245
};
#endif
...
static const char *const yytname[] =
{
  ...
  "_FOR", "_DOWNTO", "_DO", "$accept", "program", "function_list",
  ...
  "$@3", "argument", "for_statement", "if_statement", "if_part", "rel_exp",
...
{
       4,   -57,    10,     4,   -57,     7,   -57,   -57,   -57,    14,
       4,    13,     6,   -57,   -57,    21,   -57,   -57,     4,    44,
     -57,    -1,    37,    26,    31,    39,   -57,   -57,    47,   -57,
     -57,   -57,   -57,   -57,    50,   -57,   -57,    31,    46,   -57,
     -57,    31,    27,   -57,   -57,   -57,    31,    15,    43,    25,
      29,    48,    51,    19,   -57,    31,    32,   -57,    41,   -57,
      31,    25,    31,   -57,   -57,   -57,    38,    49,   -57,    49,
      52,    41,   -57,    45,    25,   -57
};
...
{
     -57,   -57,   -57,    57,   -57,   -57,    -2,   -57,   -57,   -57,
     -57,    36,   -48,   -57,   -57,   -37,     9,   -56,   -57,   -57,
     -57,   -57,   -57,   -57,   -57,   -57
};
...
{
      50,    59,    66,    23,    53,    24,    25,     1,    11,    56,
       6,    26,    27,    68,     8,    73,    19,    14,    28,    23,
      13,    24,    25,    67,    10,    69,    75,    26,    57,    23,
      63,    24,    25,    16,    28,    55,    37,    26,    38,    39,
      40,    41,    54,    55,    28,    55,    60,    65,    55,    39,
      40,    22,    36,    46,    48,    49,   -32,    58,    71,    61,
       7,    62,    47,    72,    64,    55,    74
};

static const yytype_uint8 yycheck[] =
{
      37,    49,    58,     4,    41,     6,     7,     3,    10,    46,
       0,    12,    13,    61,     7,    71,    18,    11,    19,     4,
       7,     6,     7,    60,    10,    62,    74,    12,    13,     4,
      11,     6,     7,    12,    19,    16,    10,    12,     7,     8,
       9,    10,    15,    16,    19,    16,    17,    15,    16,     8,
       9,     7,    15,    14,     7,     5,    10,    14,    20,    11,
       3,    10,    26,    11,    55,    16,    21
};
...
static const yytype_uint8 yystos[] =
{
      ...
      10,    28,    29,     7,    11,    27,    12,    30,    31,    28,
      32,    33,     7,     4,     6,     7,    12,    13,    19,    34,
      35,    36,    43,    44,    45,    47,    15,    10,     7,     8,
       9,    10,    37,    38,    39,    40,    14,    33,     7,     5,
      37,    46,    41,    37,    15,    16,    37,    13,    14,    34,
      17,    11,    10,    11,    38,    15,    39,    37,    34,    37,
      42,    20,    11,    39,    21,    34
};
...
#line 93 "semantic.y" /* yacc.c:1646  */
    {  (yyval.i) = (yyvsp[0].i); }
#line 1336 "semantic.tab.c" /* yacc.c:1646  */
    break;
...
#line 218 "semantic.y" /* yacc.c:1646  */
    ...
    if(idx == -1)
      err("'%s' undeclared", (yyvsp[-6].s));
    if(get_type(idx) != get_type((yyvsp[-4].i)) || get_type(idx) != get_type((yyvsp[-2].i)))
...
#line 252 "semantic.y" /* yacc.c:1906  */
