...
#line 149 "semantic.tab.c" /* yacc.c:355  */
};
...
#line 166 "semantic.tab.c" /* yacc.c:358  */
...
{
       0,    51,    51,    63,    64,    69,    77,    68,    99,   105,
     107,   116,   119,   121,   125,   127,   126,   136,   145,   147,
     151,   152,   153,   154,   158,   162,   175,   176,   184,   185,
     193,   194,   199,   202,   208,   207,   225,   227,   237,   238,
     242,   246,   254
};
#endif
...
{
       5,   -49,    10,     5,   -49,     6,   -49,   -49,   -49,     7,
       5,     8,     9,   -49,   -49,    34,   -49,   -49,     5,    15,
     -49,    24,    -1,   -49,    28,   -49,    37,    23,    35,   -49,
     -49,   -49,   -49,   -49,   -49,    43,   -49,   -49,   -49,   -49,
      23,    40,    23,    25,   -49,   -49,   -49,    23,    12,    22,
      36,    26,    41,    44,    -7,   -49,    23,    29,   -49,   -49,
     -49,    23,    22,    23,   -49,   -49,   -49,    39,   -49,    39,
      42,   -49
};
...
{
       0,     8,     0,     2,     3,     0,     1,     4,     5,     0,
       9,     0,     0,    10,     6,     0,    12,     7,    18,     0,
      13,     0,     0,    17,     0,    14,     0,     0,     0,    18,
      11,    19,    20,    21,    22,    38,    23,    32,    33,    15,
       0,    29,     0,     0,    26,    28,    30,     0,     0,     0,
       0,     0,     0,     0,     0,    42,     0,     0,    24,    39,
      16,     0,     0,    36,    31,    27,    25,    41,    40,    37,
       0,    35
};
...
{
     -49,   -49,   -49,    53,   -49,   -49,    17,   -49,   -49,   -49,
     -49,   -49,   -49,    30,   -48,   -49,   -49,   -40,     1,    38,
...
static const yytype_int8 yydefgoto[] =
{
      ...
      20,    50,    21,    22,    31,    32,    33,    43,    44,    45,
      46,    53,    70,    34,    35,    52,    36
};
...
{
      51,    59,    54,    26,    64,    27,    28,    57,     1,    56,
       6,    29,    30,     8,    68,    13,    26,    10,    27,    28,
      14,    67,    23,    69,    29,    58,    26,    11,    27,    28,
      41,    37,    38,    42,    29,    19,    37,    38,    24,    25,
      55,    56,    56,    61,    66,    56,    16,    40,    49,    47,
     -34,    60,    62,    71,    63,    56,     7,    65,     0,    48,
       0,     0,    39
};

static const yytype_int8 yycheck[] =
{
      40,    49,    42,     4,    11,     6,     7,    47,     3,    16,
       0,    12,    13,     7,    62,     7,     4,    10,     6,     7,
      11,    61,     7,    63,    12,    13,     4,    10,     6,     7,
       7,     8,     9,    10,    12,    18,     8,     9,    14,    15,
      15,    16,    16,    17,    15,    16,    12,    10,     5,    14,
      10,    15,    11,    11,    10,    16,     3,    56,    -1,    29,
      -1,    -1,    24
};
...
static const yytype_uint8 yystos[] =
{
      ...
      29,    31,    32,     7,    14,    15,     4,     6,     7,    12,
      13,    33,    34,    35,    42,    43,    45,     8,     9,    38,
      10,     7,    10,    36,    37,    38,    39,    14,    32,     5,
      30,    36,    44,    40,    36,    15,    16,    36,    13,    33,
      15,    17,    11,    10,    11,    37,    15,    36,    33,    36,
      41,    11
};
...
#line 1297 "semantic.tab.c" /* yacc.c:1646  */
    break;
...
#line 127 "semantic.y" /* yacc.c:1646  */
    {
      if(get_type((yyvsp[-2].i)) != get_type((yyvsp[0].i)))
         err("invalid types");
      set_atr2((yyvsp[-2].i), 1); //1 u atr2 za variable kojima je barem jednom dodeljena vrednost
    }
...
#line 137 "semantic.y" /* yacc.c:1646  */
    {
      if(lookup_symbol((yyvsp[0].s), VAR|PAR) == -1)
         (yyval.i) = insert_symbol((yyvsp[0].s), VAR, (yyvsp[-1].i), ++var_num, NO_ATR);
      else 
...
#line 186 "semantic.y" /* yacc.c:1646  */
    {
        ...
        if(get_atr2((yyval.i)) != 1)
          err("variable %s is used and value is never set.",get_name((yyval.i)));
      }
...
#line 261 "semantic.y" /* yacc.c:1906  */
